//Get #pageContent element Obtenir #pageContent élément
let pageContent = document.getElementById('pageContent');
//get #pictInfo div obtenir #pictInfo div
let pictInfo = document.getElementById('pictInfo');
//Define the images array Définir le tableau d’images
...
//Choose a random image Choisissez une image aléatoire
let randomImage = images[Math.floor(Math.random() * images.length)];

//apply the image as the background of pageContent appliquer l’image comme arrière-plan de pageContent
pageContent.style.backgroundImage = `url(/images/${randomImage.filename})`;

if(pictInfo){
    //Empty the pictInfo div Vider le div pictInfo Vider le pictInfo div Vider le div pictInfo
    while(pictInfo.firstChild){
        pictInfo.removeChild(pictInfo.firstChild);
    }

    //Create pictInfo title and add it to the Div Créez le titre pictInfo et ajoutez-le au Div
    ...
    //Create author and exposure P and add them to pictInfo Créez l’auteur et l’exposition P et ajoutez-les à pictInfo
