...
.pauseFor(1800)
.changeDelay(20)
.typeString('LA POSTE DE L\'ANCIENNE FRANCE')
.pauseFor(300)
.typeString('<strong>, Des origines a 1849</strong> !')
.pauseFor(1000)
.deleteChars(21)
.typeString('<span style="color: #FC2F04;"> Marques manusrittes</span> !')
.pauseFor(1000)
.deleteChars(21)
.typeString('<span style="color: #EA39ff;"> Au Tampon</span> !')
.pauseFor(1000)
.deleteChars(11)
.typeString('<span style="color: #FFFFFF;"> A numero</span> !')
.pauseFor(1000)
.deleteChars(10)
.typeString('<span style="color: #FB040F;"> A sec</span> !')
.start()
